---
title: "Import IPUMS PMA Data"
description: |
  How to get an IPUMS PMA data extract and import it into R
author:
  - name: Matt Gunther
...
## User Guide 
Visit the IPUMS PMA [data dissemination website](pma.ipums.org) to browse the available data, and then follow the posted [user guide](https://pma.ipums.org/pma/userguide.shtml) to get started with an extract of interest. 
...
You will receive an email when your extract request has been processed. Click the included link to find a download page like this:

*You must download both the data file and the DDI codebook*:
